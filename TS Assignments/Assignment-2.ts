...
var length:number,width,area:number;
length=4;
width=6;
area=length*width;
...
var length:number,volume:number;
length=7;
volume=length**3;
...
else {console.log("The given number is negative");
}
...
function ctof(temp1:number){
    //temp1 is temperature is temperature in celcius
    var temp2:number; //temp2 is temperature in farhenheit
    ...
    function percentage(marksobtained:number) {
        var percentageobtained:number;
...
var totaldays,weeks,days:number;
totaldays=25;
weeks=totaldays/7;
days=totaldays%7;
...
function daystoweeks(day:number){
    var weeks,days:number;
    weeks=day/7;
    days=day%7;
...
function usercatagory(age:number) {
    if (age<=12) {
...
function weather(temperature:number) //temperature is in celcius
{
    if (temperature<=10) {
...
function divisible(givenNumber:number) {
    var a,b:number;
    a=givenNumber%3;
    b=givenNumber%5;
    if (a==0 && b==0)
...
function weekday(a:number) {
    if (a==1) {console.log(`It's Monday.`);}
    else if (a==2){console.log(`It's Tuesday.`);}
    else if (a==3){console.log(`It's Wednesday.`);}
    else if (a==4){console.log(`It's Thursday.`);}
    else if (a==5){console.log(`It's Friday.`);}
    else if (a==6){console.log(`It's Saturday.`);}
    else if (a==7){console.log(`It's Sunday.`);}
    else{console.log(`You have entered the invalid number. Please enter between 1-7.`);}
    return a;
    }
    weekday(4);
...
*/
var units:number;
var priceOfUnit:number=27; //price of 1 unit is 27 
...
tax=Bill(units);
totalcost=units*priceOfUnit;
var billIncludingTax:number=totalcost+tax;
